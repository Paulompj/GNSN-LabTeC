...
urlpatterns = [
    ...
    path("updateguarda/<int:pk>/", createguarda, name="updateguarda"),
    path("readguarda/", readguarda, name="readguarda"),
    path("passwordguarda/<int:pk>/", passwordguarda, name="passwordguarda"),
    path("permissoes/<int:pk>/", permissoes, name="permissoes"),
